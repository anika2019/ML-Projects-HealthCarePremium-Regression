...
# Resolve paths relative to this script (works when deployed on Streamlit Cloud)
_SCRIPT_DIR = Path(__file__).resolve().parent
_ARTIFACTS_DIR = _SCRIPT_DIR / "artifacts"

model_young = joblib.load(_ARTIFACTS_DIR / "best_model_young_model_with_genetical_risk_factor.joblib")
model_rest = joblib.load(_ARTIFACTS_DIR / "best_oldage_model_with_genetical_risk_factor.joblib")
scaler_young = joblib.load(_ARTIFACTS_DIR / "scaler_old_with_cols.joblib")
scaler_rest = joblib.load(_ARTIFACTS_DIR / "scaler_young_with_cols.joblib")
